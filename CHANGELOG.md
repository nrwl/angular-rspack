...
- initial scaffold ([bf28f76](https://github.com/nrwl/angular-rspack/commit/bf28f76))
- initial version of ng-rspack/build ([7e44bd2](https://github.com/nrwl/angular-rspack/commit/7e44bd2))
- add new angular- packages and create legacy packages ([#3](https://github.com/nrwl/angular-rspack/pull/3))
- **angular-rspack:** add withConfigurations ([#6](https://github.com/nrwl/angular-rspack/pull/6))
- **angular-rspack:** support expanded syntax for `assets`, `styles`, and `scripts` ([#28](https://github.com/nrwl/angular-rspack/pull/28))
- **angular-rspack:** support `extractLicenses` option ([#30](https://github.com/nrwl/angular-rspack/pull/30))
- **angular-rspack:** improve createConfig public api ([#35](https://github.com/nrwl/angular-rspack/pull/35))
- **angular-rspack,angular-rsbuild:** refactor withConfigurations to be createConfig ([#9](https://github.com/nrwl/angular-rspack/pull/9))
- **angular-rspack,angular-rsbuild:** rename jit to aot ([#11](https://github.com/nrwl/angular-rspack/pull/11))
- **angular-rspack,angular-rsbuild:** rename tsconfigPath to tsConfig ([#13](https://github.com/nrwl/angular-rspack/pull/13))
- **angular-rspack,angular-rsbuild:** rename inlineStylesExtension to inlineStyleLanguage ([#14](https://github.com/nrwl/angular-rspack/pull/14))
- **angular-rspack,angular-rsbuild:** support passing devServer options ([#16](https://github.com/nrwl/angular-rspack/pull/16))
- **angular-rspack,angular-rsbuild:** add optimization option ([#21](https://github.com/nrwl/angular-rspack/pull/21))
- **angular-rspack,angular-rsbuild:** rename ssrEntry to ssr.entry ([#20](https://github.com/nrwl/angular-rspack/pull/20))
- **angular-rspack,angular-rsbuild:** add outputHashing option ([#22](https://github.com/nrwl/angular-rspack/pull/22))
- **angular-rspack,angular-rsbuild:** support `ssl`, `sslKey`, `sslCert`, and `proxyConfig` options ([#24](https://github.com/nrwl/angular-rspack/pull/24))
- **angular-rspack,angular-rsbuild:** turn on/off advanced optimizations based on provided options ([#26](https://github.com/nrwl/angular-rspack/pull/26))
- **angular-rspack,angular-rsbuild:** remove root from api ([#23](https://github.com/nrwl/angular-rspack/pull/23))
- **angular-rspack,angular-rsbuild:** add outputPath option ([#27](https://github.com/nrwl/angular-rspack/pull/27))
- **angular-rspack,angular-rsbuild:** add sourcemap option ([#29](https://github.com/nrwl/angular-rspack/pull/29))
- **angular-rspack,angular-rsbuild:** add chunking options ([#31](https://github.com/nrwl/angular-rspack/pull/31))
- **angular-rspack,angular-rsbuild:** add `root` option and improve `tsConfig` handling ([#33](https://github.com/nrwl/angular-rspack/pull/33))
...
- **build:** add rsbuild plugin ([#27](https://github.com/nrwl/angular-rspack/pull/27))
...
- fix eslint-next script for fully refactored state ([#126](https://github.com/nrwl/angular-rspack/pull/126))
- **angular-rspack:** sass-loader should not be required when using css ([#32](https://github.com/nrwl/angular-rspack/pull/32))
- **angular-rspack:** dev-server works for ssr ([#34](https://github.com/nrwl/angular-rspack/pull/34))
